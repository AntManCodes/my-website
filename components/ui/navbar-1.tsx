...
const Navbar1 = () => {
  ...
  return (
    <div className="flex justify-center w-full py-6 px-4">
      <div className="flex items-center justify-between px-6 py-3 bg-card border border-border/50 rounded-full shadow-lg w-full max-w-3xl relative z-10">
            ...
            <div className="flex flex-col space-y-6">
              {["Overview", "Specs", "Use Cases", "Contact"].map((item, i) => (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                >
                  <a href="#" className="text-base text-foreground font-medium" onClick={toggleMenu}>
                    {item}
                  </a>
                </motion.div>
              ))}
